...
// 2. Load data structures directly
import newsData from '../../data/news.json';
import rawVideoData from '../../data/videos.json';
import resourceData from '../../data/resources.json';

// 3. Reuse our clean folder component imports using root directory index paths
  ...
  return (
    <>
      ...
      <main className="page-container home-search-panel">
        ...
        {/* Overlapping Search Bar Console Dashboard */}
